...
class TestRAGSystemEndToEnd:
    ...
    def test_full_query_flow_with_tool_call(
        ...
        # Setup mocks
        mock_ai_gen = Mock()
        mock_ai_gen.generate_response.return_value = "ML is a subset of AI that focuses on learning from data."
        mock_ai_generator_class.return_value = mock_ai_gen
    ...
    def test_query_with_conversation_context(
        ...
        # Setup mocks
        mock_ai_gen = Mock()
        mock_ai_gen.generate_response.return_value = "Yes, supervised learning uses labeled data."
        mock_ai_generator_class.return_value = mock_ai_gen
